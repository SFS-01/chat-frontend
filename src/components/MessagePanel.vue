            ...
            <section class="chat-window-wrapper">
                ...
                <div v-show="$store.state.selectedType" class="chat-area">
                        ...
                        <header class="d-flex justify-content-between align-items-center px-1 py-75">
                            <div class="d-flex align-items-center">
                                <div class="chat-sidebar-toggle d-block d-lg-none mr-1">
                                    <i class="feather icon-message-square font-large-1 cursor-pointer"></i>
                                </div>
                    ...
                    <div class="card chat-wrapper shadow-none mb-0">
                        ...
                        <div class="card-footer px-2 py-1 pb-0">
                            <form @submit.prevent="onMessage" class="form">
                                <div class="row">
                                    <div class="col-2">
                                    ...
                                    <div class="col-8">
                                        <input v-model="message" type="text" class="form-control chat-message-send mx-1" placeholder="Type your message here...">
                                    </div>
                                    <div class="col-2">
